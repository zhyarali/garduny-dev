    ...
    >
      ...
      <v-list-item
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title class="subtitile-1">About Me</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
     ...
     <v-container class="header-container">
      ...
      <v-toolbar flat class="header-color">

      <v-toolbar-title><h3 class="logo-title">Garduny</h3></v-toolbar-title>
...
<div v-if="isDesktop">
    ...
    @click="toggle_dark_mode()"
      ...
      elevation="0"
      color="white"
      class="mx-6 theme-btn"
    >
     <span v-if="$vuetify.theme.dark==false" class="material-icons-round" >dark_mode</span>
    <span v-if="$vuetify.theme.dark==true" class="material-icons-round" >wb_sunny</span>
...
export default {
  ...
  data: () => ({
      grad:{'background':'#EEEDF7 !important'},
    drawer: null,
    isXs: false,
    isDesktop:false,
    goDark:false,
  ...
  methods: {
    onResize() {
      ...
      this.isDesktop = window.innerWidth > 850;
    },
    toggle_dark_mode() {
